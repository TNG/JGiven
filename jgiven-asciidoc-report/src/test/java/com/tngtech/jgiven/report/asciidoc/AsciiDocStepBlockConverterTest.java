...
class AsciiDocStepBlockConverterTest {
    ...
    class SuccessfulExecution {
        ...
        void convert_step_with_special_argument() {
            // given
            List<Word> words = List.of(Word.introWord("given"), new Word("the coffee machine"),
        ...
        void convert_step_with_parameter() {
            ...
            List<Word> words = List.of(Word.introWord("given"), new Word("a coffee machine with"), ncoffees, new Word("coffees"));
        ...
        void convert_step_with_data_table_with_horizontal_header() {
            // given
            List<List<String>> productsTable = List.of(List.of("product", "price"), List.of("apples", "23"),
                    List.of("pears", "42"));
        ...
        void convert_step_with_data_table_vertical_header() {
            // given
            List<List<String>> productsTable = List.of(List.of("product", "apples", "pears"), List.of("price", "23", "42"));
            List<Word> words = List.of(Word.introWord("given"), new Word("the products"),
                    Word.argWord("products", productsTable.toString(),
