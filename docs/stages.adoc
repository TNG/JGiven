...
[source,java]
----
include::{sourcedir}/pancakes/test/steps/WhenCook.java[tags=cookManglesDough]
----
...
[source,java]
----
include::{sourcedir}/pancakes/test/steps/WhenCook.java[tags=cookDrinksMilk]
----
The step will appear as `the cook drinks 50% of the milk accidently` in the report.
...
[source,java]
----
include::{sourcedir}/rocket/RocketMethods.java[tags=hiddenRocket]
----
...
[source,java]
----
include::{sourcedir}/rocket/RocketMethods.java[tags=rocketDesc]
----
...
[source,java]
----
include::{sourcedir}/subclassing/CommonStagesTest.java[tags=onlyMethod]
----
