...
configuration with the link:{javascripturl}/EnableJGiven.html[`@EnableJGiven`] annotation.
...
the stage class with the link:{javascripturl}/JGivenStage.html[`@JGivenStage`] annotation.
