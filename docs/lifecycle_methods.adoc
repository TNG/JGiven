...
.. The `@AfterStage`-annotated methods of the stage are called 4.5. The values of all scenario state fields are extracted.
...
[source,java]
----
include::{sourcedir}/webdriver/MyStage.java[tags=start]
----
...
[source,java]
----
include::{sourcedir}/webdriver/MyStage.java[tags=middle]
----
...
[source,java]
----
include::{sourcedir}/webdriver/WebDriverRule.java[tags=noPackage]

include::{sourcedir}/webdriver/MyStage.java[tags=rule]
