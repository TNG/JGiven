...
=== Ordinal Case Description

If your test has multiple cases, you can use the `@OrdinalCaseDescription` to provide additional information to the description for each case.
...
+---+-----------------------+-----------+-------
| 1 |      On the first run |  quite ok | SUCCESS
| 2 | And on the second run | well-done | SUCCESS
----
