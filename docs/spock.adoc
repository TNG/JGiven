== Spock
:javadocurl: http://static.javadoc.io/com.tngtech.jgiven/jgiven-spock2/{version}/com/tngtech/jgiven/spock
...
Spock support is provided by the `jgiven-spock2` dependency.
...
<dependency>
   ...
   <artifactId>jgiven-spock2</artifactId>
