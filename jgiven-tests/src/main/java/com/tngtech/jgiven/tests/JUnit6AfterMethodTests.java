...
public class JUnit6AfterMethodTests extends ScenarioTestBase<GivenTestStage, WhenTestStage, ThenTestStage> {
    ...
    @Test
    public void a_failing_JUnit_6_test() {
        given().nothing();
        when().a_step_fails();
    ...
    @Test
    public void a_succeeding_JUnit6_test() {
        given().nothing();
    ...
    @Test
    @Disabled
    public void a_skipped_JUnit6_test() {
        given().nothing();
        when().something_happens();
        then().something_happened();
    }
