...
public class ReportModelHtmlWriter extends ReportModelVisitor {
    ...
    public void visit( ReportModel reportModel ) {
        ...
        if( !reportModel.getScenarios().isEmpty() ) {
            ...
            writer.println( "<i class='icon-plus-squared-alt' id='expand-all-icon' "
                    + "title='Expand All' onclick='expandAllClicked()'></i>" );
            writer.println( "<i class='icon-minus-squared-alt' id='collapse-all-icon' "
                    + "title='Collapse All' onclick='collapseAllClicked()'></i>" );
        }
    }
