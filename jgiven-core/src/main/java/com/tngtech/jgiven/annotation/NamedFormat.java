...
public @interface NamedFormat {
     ...
     * 
     * <p>
     * Mutually exclusive with {@link #customFormatAnnotation()}
     * </p>
     */
     ...
     */
    Class<? extends Annotation> customFormatAnnotation() default Annotation.class;
}
