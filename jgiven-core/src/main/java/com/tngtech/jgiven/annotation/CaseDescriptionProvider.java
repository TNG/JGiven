...
public interface CaseDescriptionProvider {
     ...
     * @param value the value provided by the {@link com.tngtech.jgiven.annotation.OrdinalCaseDescription} annotation.
     * @param parameterNames the parameter names
     * @param parameterValues the parameter values. Depending on the value of {@link OrdinalCaseDescription#formatValues()}, this is
