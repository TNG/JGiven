...
public class DataTableFormatterTest {
    ...
    public void testNumberedRows() {
        ...
        assertThat( toTableValue( TABLE_WITH_THREE_ROWS_AND_TWO_COLUMNS, tableAnnotation ).getData() )
            .isEqualTo( newArrayList( newArrayList( "#", "h1", "h2" ), newArrayList( "1", "a1", "a2" ), newArrayList( "2", "b1", "b2" ) ) );
    }
    ...
    public void testNumberedRowsHeader( String header ) {
        ...
        assertThat( toTableValue( TABLE_WITH_THREE_ROWS_AND_TWO_COLUMNS, tableAnnotation ).getData() )
            .isEqualTo(
                newArrayList( newArrayList( header, "h1", "h2" ), newArrayList( "1", "a1", "a2" ), newArrayList( "2", "b1", "b2" ) ) );
    }
    ...
    public void testNumberedColumns() {
        ...
        assertThat( toTableValue( TABLE_WITH_THREE_ROWS_AND_TWO_COLUMNS, tableAnnotation ).getData() )
            .isEqualTo( newArrayList( newArrayList( "#", "1", "2" ), newArrayList( "h1", "a1", "b1" ), newArrayList( "h2", "a2", "b2" ) ) );
    }
    ...
    public void testNumberedColumnsHeader( String header ) {
        ...
        assertThat( toTableValue( TABLE_WITH_THREE_ROWS_AND_TWO_COLUMNS, tableAnnotation ).getData() )
            .isEqualTo(
                newArrayList( newArrayList( header, "1", "2" ), newArrayList( "h1", "a1", "b1" ), newArrayList( "h2", "a2", "b2" ) ) );
    }
