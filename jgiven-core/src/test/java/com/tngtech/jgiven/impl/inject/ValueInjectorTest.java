...
public class ValueInjectorTest {
    ...
    @Test(expected = JGivenMissingRequiredScenarioStateException.class)
    public void null_expected_state_field_throws_exception() throws Throwable {
        FakeStage stageObject = new FakeStage("", "", null);
    ...
    @Test
    public void initialized_expected_fields_do_not_interrupt_execution() throws Throwable {
