...
/**
 * This extension enables JGiven for JUnit 5 and JUnit 6 Tests.
 * <p>
...
public class JGivenExtension implements
    ...
    public void beforeAll(ExtensionContext context) {
        ...
        AbstractJGivenConfiguration configuration = ConfigurationUtil.getConfiguration(context.getTestClass().orElseThrow());
        if (configuration.getTagConfiguration(Tag.class) == null) {
            configuration.configureTag(Tag.class)
                    .description("JUnit 5/6 Tag")
                .color("orange");
        }
    }
